...
public class TC2 extends TestCase {
	...
	@Test
	public void testSelezioneOrdinazionePerTavolo() throws Exception {
		User user_test = null;
		try {
		...
		try {
			ordinazione2 = ordinazioneFacade.selezionaOrdinazionePerTavolo(user_test, tavolo.getRiferimento(), false);
		} catch (Exception e) {
			ordinazione2 = null;
		} 
