...
public class TC5 extends TestCase {
	...
	public void setUp() throws Exception {
		...
		linea = new LineaOrdinazione();
		linea.setOrdinazione(ordinazione);
		linea.setId(10L);
		linea.setArticolo(null);
		
	//	ordinazione.setLineaOrdinaziones(linea);
	...
	@Test
	public void testSelezioneLineaOrdinazione() throws RemoteException {
