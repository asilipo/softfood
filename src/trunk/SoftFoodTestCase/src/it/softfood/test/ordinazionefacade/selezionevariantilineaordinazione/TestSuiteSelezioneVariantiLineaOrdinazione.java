package it.softfood.test.ordinazionefacade.selezionevariantilineaordinazione;
...
public class TestSuiteSelezioneVariantiLineaOrdinazione {

	public static Test suite() {
		TestSuite suite = new TestSuite(
				"Test for it.softfood.test.ordinazionefacade.selezionevariantilineaordinazione");
		//$JUnit-BEGIN$
