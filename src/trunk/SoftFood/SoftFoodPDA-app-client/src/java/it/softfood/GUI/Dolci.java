...
public class Dolci extends javax.swing.JPanel {
    ...
    public Dolci(FrameView frame, Long tavolo) {
        ...
        ArrayList<it.softfood.entity.Pietanza> dolci = (ArrayList<it.softfood.entity.Pietanza>) articolo.selezionaPietanzeDisponibiliPerTipo(TipoPietanza.DOLCE);

        tabella_dolci.setModel(new javax.swing.table.DefaultTableModel(new String[]{"ID", "Dolce", "Quantita'"}, dolci.size()));
        ...
        tabella_dolci.createDefaultColumnsFromModel();
        
        id=id_antipasto.getColumnByModelIndex(0);

        int i = 0;
        int j = 0;
        for(it.softfood.entity.Pietanza pietanza:dolci){
            tabella_dolci.setValueAt(pietanza.getId(), i, j++);
            tabella_dolci.setValueAt(pietanza.getNome(), i++, j);
            j = 0;
        }
    ...
    private void initComponents() {
        ...
        pannello_dolci = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tabella_dolci = new javax.swing.JTable();
        ...
        tabella_dolci.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabella_dolci.getColumnModel().getColumn(1).setResizable(false);
        tabella_dolci.getColumnModel().getColumn(2).setResizable(false);

        pannello_dolci.add(jScrollPane1, java.awt.BorderLayout.CENTER);
        ...
        pannello_dolci.add(jPanel1, java.awt.BorderLayout.SOUTH);

        add(pannello_dolci, java.awt.BorderLayout.NORTH);
...
// TODO add your handling code here:
    int row=tabella_dolci.getSelectedRow();
    id_antipasto.setColumnVisible(id, true);
    long id_long=((Long)tabella_dolci.getValueAt(row, 0)).longValue();
...
// TODO add your handling code here:
   ...
   frame.setComponent(pietanza);  
    ...
    private javax.swing.JPanel pannello_dolci;
    private javax.swing.JPanel pannello_ordini;
    private javax.swing.JTable tabella_dolci;
